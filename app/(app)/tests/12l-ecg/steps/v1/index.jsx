...
const V1TestScreen = () => {
  ...
  const handleMoveToNext = () => {
    router.push('/tests/12l-ecg/steps/v2');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.leadButtonsContainer}>
        <LeadButtons activeLead="V1" disabled={isRecording} />
      </View>
      ...
      {!isRecording ? (
        ...
        <View style={styles.recordingContainer}>
          ...
          {isRecordingComplete && (
            ...
            >
              <Text style={styles.buttonText}>Move to next</Text>
            </TouchableOpacity>
          )}
        </View>
      )}
